...
case 'Dark': 
				{
				var bg:BGSprite = new BGSprite('Darkar/1', 300, 200, 1, 1);
				bg.setGraphicSize(Std.int(bg.width * 4));
				add(bg);

				var stageFront:BGSprite = new BGSprite('Darkar/2', -1630, -915, 1, 1);
				stageFront.setGraphicSize(Std.int(stageFront.width * 4));
				stageFront.updateHitbox();
				add(stageFront);

				var stageLight:BGSprite = new BGSprite('Darkar/3', -1630, -930, 1, 1);
				stageLight.setGraphicSize(Std.int(stageLight.width * 4));				
				...
				case 'Cangrejo':
					{
				var bg:BGSprite = new BGSprite('cangrejoxd/meco', -500, 100, 1, 1);
				...
				add(bg);
					...
					case 'tiempo':
						{
					var bg:BGSprite = new BGSprite('Darkar/tiempo', -500, 100, 1, 1);
				...
				case 'sillon': {
				var bg:BGSprite = new BGSprite('sillonxd/sillonxd', -900, 100, 1, 1);
				bg.setGraphicSize(Std.int(bg.width * 0.8));
				add(bg);
				
				if (SONG.song.toLowerCase()== 'videojuegos'){
	
					var GFvergas:FlxSprite = new FlxSprite(700,780);
					GFvergas.frames= Paths.getSparrowAtlas('characters/Gf_con_verga');
					GFvergas.animation.addByPrefix('idle','idle00',15);
					GFvergas.animation.play('idle');
					GFvergas.scale.set(0.9,0.9);
					add(GFvergas);
				}
			}
			case 'stage': //Week 1
